    ...
    <>
      ...
      <MainContainer style='lg:py-24 flex flex-col w-full items-center justify-center gap-6'>
        <div className="flex justify-center">
          <AnimatedText text={`Don't be shy, Hit me up!👇`} style='text-4xl lg:text-6xl text-center' />
        </div>
        <div className='flex flex-col items-center justify-center w-full gap-4'>
          <ContactButton url='https://www.linkedin.com/in/aldi-abdu-malik-4a3018195/' style='!bg-[#0A66C2]'>
            <div className='absolute left-[27%] md:left-[30%] xl:left-[35%] flex h-full min-w-min items-center gap-4 overflow-hidden'>
